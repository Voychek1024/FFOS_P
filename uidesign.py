...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_2.setStyleSheet("background-image: url(:/newPrefix/Order.png);")
    ...
    def retranslateUi(self, Form):
        ...
        self.treeWidget.headerItem().setText(1, _translate("Form", "Price"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("Form", "Instruction"))
        self.treeWidget.topLevelItem(0).child(0).setText(0, _translate("Form", "Select Store to order"))
